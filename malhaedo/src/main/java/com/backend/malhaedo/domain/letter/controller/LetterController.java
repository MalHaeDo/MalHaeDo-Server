...
public class LetterController {
    ...
    public ApiResponse<LetterResponse.LetterResponseDTO> sendLetter(@RequestBody LetterRequestDTO.LetterRequest request) {
        LetterResponse.LetterResponseDTO response = letterService.createLetter();
